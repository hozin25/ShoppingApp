    ...
    <view class="content">
        <view class="box"
            ...
            <view class="forget-input forget-margin-b">
                <input v-model="phone"
                       :style='{"padding":"0 24rpx","boxShadow":"0px 6rpx 12rpx var(--publicSubColor)","margin":"6rpx 0rpx","borderColor":"#ccc","backgroundColor":"rgba(255, 255, 255, 1)","color":"#333","textAlign":"left","borderRadius":"40rpx 0","borderWidth":"0","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                       type="text" placeholder="请输入注册时的手机号" />
            </view>
            ...
            async onResetPass() {
                ...
                try {
                    const [err, res] = await uni.request({
                        url: this.$base.url + 'yonghu/resetPass',
                        method: 'POST',
                        header: {
                        ...
                        data: {
                            ...
                            yonghu_phone: this.phone,
                            tableName: this.optionsValues[this.index]
                        }
                    });
                    ...
                    if (res.data.code == 0) {
                        ...
                        this.$utils.msg(res.data.msg || '重置密码失败')
                    }
                } catch(e) {
                    console.error(e)
                    this.$utils.msg('重置密码失败')
                }
            },
            optionsChange(e) {
...
<style>
    ...
    .content:after {
        ...
        bottom: 0;
        content: '';
        background-image: url(http://localhost:8080/zhinengxiaochengxsc/img/front-img-bg.jpg);
